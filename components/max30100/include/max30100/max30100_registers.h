...
uint8_t max30100_device_address = MAX30100_DEVICE;
...
/**
 * @brief Pulse detection algorithm. Called by the update function.
 * 
...
/**
 * @brief Balance intensities filter. DC filter for the raw values.
 * 
 * @param this is the address of the configuration structure.
